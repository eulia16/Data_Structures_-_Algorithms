...
public void writeData(String fileName, Map<String, String> idToCategories) throws FileNotFoundException, IOException{
    if(idToCategories.get(fileName) != null){
        RandomAccessFile reader = new RandomAccessFile("/Users/ethan/Desktop/ds2TestFiles/" + fileName, "rw");
        ...
        channel.write(buff);
//        buff = ByteBuffer.wrap(idToLong.get(file).toString().getBytes(StandardCharsets.UTF_8));
//        channel.write(buff);
//        buff = ByteBuffer.wrap("\nLatitude:".getBytes(StandardCharsets.UTF_8));
//        channel.write(buff);
//        buff = ByteBuffer.wrap(idToLat.get(file).toString().getBytes(StandardCharsets.UTF_8));
//        channel.write(buff);
//        buff = ByteBuffer.wrap("\nStars:".getBytes(StandardCharsets.UTF_8));
//        channel.write(buff);
//        buff = ByteBuffer.wrap(idToStars.get(file).toString().getBytes(StandardCharsets.UTF_8));
//        channel.write(buff);
//        buff = ByteBuffer.wrap("\nIsOpen:".getBytes(StandardCharsets.UTF_8));
//        channel.write(buff);
//        buff = ByteBuffer.wrap(idToIsOpen.get(file).toString().getBytes(StandardCharsets.UTF_8));
//        channel.write(buff);
        reader.close();
}
}
...
public String readData(String fileName) throws FileNotFoundException, IOException{
        String categories;
        ByteBuffer test;
        RandomAccessFile reader = new RandomAccessFile("/Users/ethan/Desktop/ds2Files/" + fileName, "rw");
        FileChannel channel = reader.getChannel();
